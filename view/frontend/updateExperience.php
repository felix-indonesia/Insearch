        ...
        <div class='row'>
                    ...
                    <div class='row'>
                        ...
                        <div class="tab-content">
                            ...
                            <div class='form-group col-sm-12'>
                                ...
                                <textarea class='form-control tiny' name='experience'>Lorem Ipsum Dolor</textarea>
                            </div>
                           
                            <div class="form-group col-sm-12">
                                <button type="submit" class="btn btn-orange btn-lg pull-right" name='updateExperience'><i class='fa fa-floppy-o fa-fw'></i> Save</button>                               <div class='clear'></div>
                            </div>
            ...
            <div class='col-sm-4 col-md-4 pt-15'>
                ...
                <a href='<?php echo $server_root?>/profile/update/skills'><div class="blog-link shadow">
                    <h3><i class='fa fa-graduation-cap fa-fw'></i> Update your skills</h3>
                    
                </div></a>
                
                <a href='<?php echo $server_root?>/profile/update/qualifications'><div class="blog-link shadow">
                    <h3><i class='fa fa-refresh fa-fw'></i> Update your qualifications</h3>
