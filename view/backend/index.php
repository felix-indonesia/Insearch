                    ...
                    <div class="col-md-4">
                        <div class="panel panel-success-alt noborder">
                            <div class="panel-heading noborder">
                                ...
                                <div class="media-body">
                                    <h5 class="md-title nomargin">Organised Events</h5>
                                    <h1 class="mt5">113</h1>
                                </div><!-- media-body -->
                                <hr>
                                <div class="clearfix mt20">
                                    <div class="pull-left">
                                        <h5 class="md-title nomargin">Past Events</h5>
                                        <h4 class="nomargin">95</h4>
                                    </div>
                                    <div class="pull-right">
                                        <h5 class="md-title nomargin">Upcoming Events</h5>
                    ...
                    <div class="col-md-4">
                        <div class="panel panel-primary noborder">
                            <div class="panel-heading noborder">
                                ...
                                <div class="media-body">
                                    <h5 class="md-title nomargin">Registered Volunteers</h5>
                                    <h1 class="mt5">122</h1>
                                </div><!-- media-body -->
                                <hr>
                                <div class="clearfix mt20">
                                    <div class="pull-left">
                                        <h5 class="md-title nomargin">Unactive</h5>
                                        <h4 class="nomargin">43</h4>
                                    </div>
                                    <div class="pull-right">
                                        <h5 class="md-title nomargin">Requests</h5>
                                        <h4 class="nomargin">9</h4>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="panel panel-dark noborder">
                            <div class="panel-heading noborder">
                                ...
                                <div class="panel-icon"><i class="fa fa-usd"></i></div>
                                <div class="media-body">
                                    <h5 class="md-title nomargin">Tickets sales</h5>
                                    <h1 class="mt5">$ 9,325</h1>
                                </div><!-- media-body -->
                                <hr>
                                <div class="clearfix mt20">
                                    <div class="pull-left">
                                        <h5 class="md-title nomargin">Tickets sold</h5>
                                        <h4 class="nomargin">477</h4>
                                    </div>
                                    <div class="pull-right">
