 ...
 * Document author.
 */
define ('PDF_AUTHOR', 'Student Activities Club');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Official Event Ticket');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by Student Activities Club");
 ...
 */
define('K_TIMEZONE', 'Australia/Sydney');
