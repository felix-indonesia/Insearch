...
<header>
    <div class="headerwrapper"> 
        <div class="header-left">
            <a href="<?php echo $server_root;?>admin" class="logo">
                <img src="<?php echo $server_root;?>backend/images/logo.png" alt="" /> 
            </a>
            ...
            <div class="pull-right">
                ...
                <div class="btn-group btn-group-list btn-group-notification">
                    ...
                    <div class="dropdown-menu pull-right">
                        ...
                        <ul class="media-list dropdown-list">
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb" src="<?php echo $server_root;?>backend/images/photos/user1.png" alt="">
                            ...
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb" src="<?php echo $server_root;?>backend/images/photos/user2.png" alt="">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb" src="<?php echo $server_root;?>backend/images/photos/user3.png" alt="">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb" src="<?php echo $server_root;?>backend/images/photos/user4.png" alt="">
                                <div class="media-body">
                ...
                <div class="btn-group btn-group-option">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      ...
                      <li class="divider"></li>
                      <li><a href="?signout=1"><i class="glyphicon glyphicon-log-out"></i>Sign Out</a></li>
                    </ul>
                </div><!-- btn-group -->
